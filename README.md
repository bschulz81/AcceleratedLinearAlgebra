...
Unfortunately, with the new kernel 6.17.1 and the new gpu drivers nvidia-drivers-580.95.05, there seem to occur also drastic memory problems that do not appear to come from my code but incorrect compilation by gcc and libgomp. 
