...
//
        ...
        size_t extaa[2]= {3,7};
        size_t straa[2];
        datastruct<double>A(A_data.data(),0, true,2,extaa,straa,true,true,false);
...
//
        ...
        datastruct<double>Ac=A.column_copy_s(1, exta3,stra3,newda3);
        Ac.printtensor();
        cout <<"Rank: "<<Ac.rank()<<endl;
        cout<<"row"<<endl;
        size_t extar[2];
        size_t strar[2];
        datastruct<double>Aa1=A.row(1,extar,strar);
        cout <<"C"<<endl;
        Aa1.printtensor();
        ...
        datastruct<double>Ac2=A.row_copy_s(1, exta3r,stra3r,newda3r);
        Ac2.printtensor();
        ...
        double newda4[8];
        datastruct<double>Ad= A.subspanmatrix_copy_s(1,1,2,4,exta4,stra4,newda4);
        ...
        double dataa6[21];
        datastruct<double>Af= A.transpose_copy_s(exta6,stra6,dataa6);
        ...
        datastruct<double> subT_view =T_row.subspan(offsets, sub_extents, newextT,newstrT);
        ...
        datastruct<double> subC_view2A =T_row.subspan_copy(offsets, sub_extents, newxtCa, newstrCA,buffer1);
        ...
        size_t extbb[2]= {3,7};
        size_t strbb[2];
        datastruct<double>B(B_data_colmajor.data(),21, false,2,extbb,strbb,true,true,false);
        ...
        datastruct<double> Bc1=B.column_copy_s(1, extb3,strb3,  newdb3);
        Bc1.printtensor();

        cout<<"row 1"<<endl;

        size_t extb35[2],strb35[2];
        datastruct<double>Ba2= B.row(1,extb35,strb35);
        Ba2.printtensor();
        ...
        datastruct<double> Bc3=B.row_copy_s(1, extb34,strb34,  newdb3a);
        Bc3.printtensor();
        ...
        double newdb4[8];
        datastruct<double>Bd= B.subspanmatrix_copy_s(1,1,2,4,extb4,strb4,newdb4);
        ...
        double datab6[12];
        datastruct<double>Bf= B.transpose_copy_s(extb6,strb6,datab6);
        cout<<"transpose with data copy"<<endl;
        Bf.printtensor();
        ...
        datastruct<double> subC_view2 =T_col.subspan_copy(offsetsC, sub_extentsC,newextC, sub_stridesC,buffer4);
